    ...
    <div>
          ...
          <div className="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
            ...
            <div className="max-w-3xl mb-10 lg:mb-14">
              ...
              <p className="mt-1 text-neutral-400">
                Whatever your goal - we will get you soon.
              </p>
            </div>
            {/* End Title */}
            {/* Grid */}
        ...
        autofill:pb-2"
          ...
          peer-not-placeholder-shown:text-neutral-400"
                  ...
                  <div className="mt-2">
                    ...
                    <p className="mt-5">
                      <a
                        className="group inline-flex items-center gap-x-2 py-2 px-3 bg-[#20f] font-medium text-sm text-white rounded-full focus:outline-hidden"
                        href="#"
                      >
                        Submit
                        <svg
      ...
      >
        ...
        <p className="text-gray-600 mt-2">
          We are a passionate team dedicated to making email writing effortless.
        </p>
      </motion.div>
    </div>
  );
